# نحو جستجو
XSearch با یک متن جستجو همراه است که می توانید دسته ها را تغییر دهید،
...
XSearch از ضربه های خارجی پشتیبانی می کند [DuckDuckGo] .  To مستقیماً به a
...
موتور، XSearch نمی تواند از حریم خصوصی شما در این مورد محافظت کند.
